...
global $post;
?>
<div class="spk-blogposts-item post-grid-card spbd-spkbg2 spbd-bggrey spbd-bxshdw">
	<div class="spk-blogposts-bx box-background" style="background-color: <?php echo  $background_color;?>">
		...
		<div class="spk-blogposts-text">
			...
			<h2 class="spk-blogpost-title sp-text-color" style="color: <?php echo  $text_colorpicker;?>"><a href="<?php the_permalink(); ?>"><?php echo get_the_title(); ?></a></h2>
